        ...
        <tbody>
          ...
          <tr>
            <td style={{ 
              ...
              <strong>ENDEREÇO:</strong> {order.customer_address || '_________________________________'}
            </td>
            <td style={{ 
              padding: '5px', 
              border: '1px solid black'
            }}>
              <strong>BAIRRO:</strong> {order.customer_neighborhood || '______________'}
            </td>
            <td style={{ 
              padding: '5px', 
              border: '1px solid black'
          ...
          <tr>
            ...
            <td style={{ 
              ...
              <strong>E-MAIL:</strong> {order.customer_email || '________________'}
            </td>
          </tr>
          <tr>
            <td style={{ 
              ...
              <strong>LOCAL DE ENTREGA:</strong> {order.delivery_location || '_________________________________'}
            </td>
            <td style={{ 
              padding: '5px', 
              border: '1px solid black'
            ...
            <td style={{ 
              ...
              <strong>COND.PAGTO:</strong> {order.payment_condition || '__________'}
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table style={{ 
        ...
        <thead>
          <tr style={{ backgroundColor: '#f0f0f0' }}>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'left' }}>CÓDIGO</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'left' }}>DESCRIÇÃO</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'center' }}>QUANT.</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'center' }}>UN. TABELA</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'center' }}>UN. LÍQUIDO</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'right' }}>TOTAL TABELA</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'right' }}>TOTAL LÍQUIDO</th>
            <th style={{ padding: '5px', border: '1px solid black', textAlign: 'left' }}>OBSERVAÇÕES</th>
          </tr>
        </thead>
        <tbody>
          {order.products && order.products.length > 0 ? (
            order.products.map((product, index) => (
              <tr key={index}>
                ...
                <td style={{ padding: '5px', border: '1px solid black' }}>
                  ...
                  {product.model && <div style={{ fontSize: '8pt' }}>Modelo: {product.model}</div>}
                  {(product.size || product.color || product.fabric) && (
                    <div style={{ fontSize: '8pt' }}>
                      {[product.size, product.color, product.fabric].filter(Boolean).join(' • ')}
                    </div>
                  )}
                </td>
                <td style={{ padding: '5px', border: '1px solid black', textAlign: 'center' }}>
                  {product.quantity}
                </td>
                <td style={{ padding: '5px', border: '1px solid black', textAlign: 'right' }}>
                ...
                <td style={{ padding: '5px', border: '1px solid black', fontSize: '8pt' }}>
                  {product.notes || ''}
                </td>
              </tr>
            ))
            ...
            <tr>
              <td colSpan={8} style={{ padding: '20px', textAlign: 'center', border: '1px solid black' }}>
          ...
          <tr style={{ fontWeight: 'bold', backgroundColor: '#f9f9f9' }}>
            <td colSpan={2} style={{ padding: '5px', border: '1px solid black', textAlign: 'right' }}>
              TOTAL .....
            </td>
            <td style={{ padding: '5px', border: '1px solid black', textAlign: 'center' }}>
